    ...
    <gree-page class="page-nobodysave">
      ...
      <gree-list>
        <gree-list-item :title="$language('btn.UDFanPort')">
          <gree-switch slot="after" v-model="isActive" @change="switchUDFanPort(isActive)" />
        </gree-list-item>
      </gree-list>
      <gree-radio-list :options="modes" :value="UDFanPort" icon-size="md" @change="setUDFanPort" v-show="isActive" />
    </gree-page>
  </gree-view>
</template>
