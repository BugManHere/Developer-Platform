...
import { GET_DEVICE_INFO, SET_MAC, SET_DATA_OBJECT, SET_CHECK_OBJECT, SET_REPAIR, IS_SCENE } from '../../store/types';
...
const mixin = {
  ...
  methods: {
    ...
    init() {
      ...
      hasReportedForRepair === 'true' ? this.setRepair(true) : this.setRepair(false);
